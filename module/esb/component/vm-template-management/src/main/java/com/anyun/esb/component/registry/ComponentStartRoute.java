...
public class ComponentStartRoute extends RouteBuilder {
    public static final String URI_START = "anyun-registry://component:start";
    private static final Logger LOGGER = LoggerFactory.getLogger(ComponentStartRoute.class);

    @Override
    public void configure() throws Exception {
        from(URI_START).id("AnyunCloudTemplateRegistryComponentStartRoute").process(new Processor() {
            @Override
