 ...
 * @date 4/13/16
 */
public class RegistryServiceProducer extends DefaultAnyunCloudProducer {
    private static final Logger LOGGER = LoggerFactory.getLogger(RegistryServiceProducer.class);
    private String componentName;
    private String serviceName;

    public RegistryServiceProducer(Component component, Endpoint endpoint) {
