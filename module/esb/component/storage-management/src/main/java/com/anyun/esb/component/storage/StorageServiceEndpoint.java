 ...
 * @date 4/13/16
 */
@UriEndpoint(scheme = "anyun-host",
        title = "Anyun Cloud Host Service Endpoint",
        syntax = "anyun-storage:category:name",
        label = "data-access",
        producerOnly = true)
public class StorageServiceEndpoint extends DefaultEndpoint {
    ...
    public Producer createProducer() throws Exception {
        if(category.equals("service")) {
            StorageServiceProducer businessProducer = new StorageServiceProducer(getComponent(),this);
    ...
    public StorageServiceEndpoint(String endpointUri, Component component) {
