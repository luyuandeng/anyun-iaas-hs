...
@UriEndpoint(scheme = "anyun-host",
        ...
        syntax = "anyun-host:category:name",
        label = "data-access",
        producerOnly = true)
public class HostServiceEndpoint extends DefaultEndpoint {
    ...
    public Producer createProducer() throws Exception {
        if(category.equals("service")) {
            HostServiceProducer businessProducer = new HostServiceProducer(getComponent(),this);
    ...
    public HostServiceEndpoint(String endpointUri, Component component) {
