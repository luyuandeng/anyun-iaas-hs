 ...
 */
public class CALLProjectCreateService extends AbstractBusinessService {
    private static final Logger LOGGER = LoggerFactory.getLogger(CALLProjectCreateService.class);
    public ProjectService projectService;

    public CALLProjectCreateService() {
        projectService = new ProjectServiceImpl();
    }

    @Override
    public String getName() {
        return "call_project_create";
    }
